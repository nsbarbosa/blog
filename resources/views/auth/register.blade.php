...
<div class="container">
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="field">
            ...
            <div class="control">
                <input name="name" class="input" type="text" placeholder="Digite seu nome" value="{{ old('name') }}"
                    required>
            </div>
        </div>
        ...
        <div class="field">
            ...
            <div class="control">
                <input name="password_confirmation" class="input" type="password" placeholder="Digite novamente a senha"
                    required>
            </div>
        </div>
